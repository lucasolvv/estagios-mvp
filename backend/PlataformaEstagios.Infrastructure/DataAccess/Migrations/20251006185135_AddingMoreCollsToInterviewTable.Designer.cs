...
namespace PlataformaEstagios.Infrastructure.DataAccess.Migrations
{
    ...
    [Migration("20251006185135_AddingMoreCollsToInterviewTable")]
    partial class AddingMoreCollsToInterviewTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlataformaEstagios.Domain.Entities.Application", b =>
                {
                    ...
                    b.HasKey("ApplicationIdentifier");

                    b.HasIndex("CandidateId");

                    b.HasIndex("CandidateIdentifier");

                    b.HasIndex("VacancyId", "CandidateIdentifier")
                        .IsUnique();
            ...
            modelBuilder.Entity("PlataformaEstagios.Domain.Entities.Interview", b =>
                {
                    b.Property<Guid>("InterviewIdentifier")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("InterviewIdentifier");

                    b.HasIndex("ApplicationIdentifier");

                    b.HasIndex("ApplicationIdentifier", "StartAt");

                    b.ToTable("Interviews", null, t =>
                        {
                            t.HasCheckConstraint("CK_Interviews_Duration_Positive", "\"DurationMinutes\" > 0");
                        });
                });
            ...
            modelBuilder.Entity("PlataformaEstagios.Domain.Entities.Application", b =>
                {
                    ...
                    b.HasOne("PlataformaEstagios.Domain.Entities.Candidate", "Candidate")
                        .WithMany()
                        .HasForeignKey("CandidateIdentifier")
                        .HasPrincipalKey("CandidateIdentifier")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("PlataformaEstagios.Domain.Entities.Vacancy", "Vacancy")
                        .WithMany("Applications")
            ...
            modelBuilder.Entity("PlataformaEstagios.Domain.Entities.Interview", b =>
                {
                    b.HasOne("PlataformaEstagios.Domain.Entities.Application", "Application")
                        .WithMany()
                        .HasForeignKey("ApplicationIdentifier")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("PlataformaEstagios.Domain.Entities.Vacancy", b =>
                {
                    b.HasOne("PlataformaEstagios.Domain.Entities.Enterprise", null)
                        .WithMany("Vacancies")
                        .HasForeignKey("EnterpriseIdentifier")
                        .HasPrincipalKey("EnterpriseIdentifier")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
